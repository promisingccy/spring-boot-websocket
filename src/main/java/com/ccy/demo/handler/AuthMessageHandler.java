...
import com.ccy.demo.message.AuthResponse;
import com.ccy.demo.message.UserJoinNoticeRequest;
...
public class AuthMessageHandler implements MessageHandler<AuthRequest> {
    ...
    public void execute(WebSocketSession session, AuthRequest message) {
        ...
        noticeRequest.setNickname(message.getAccessToken());
        WebSocketUtil.broadcast(UserJoinNoticeRequest.TYPE, noticeRequest); // 考虑到代码简化，我们先直接使用 accessToken 作为 User
    }
