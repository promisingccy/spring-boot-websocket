package com.ccy.demo.websocket;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ccy.demo.handler.MessageHandler;
import com.ccy.demo.message.AuthRequest;
...
//        System.out.println("afterConnectionEstablished--accessToken--" + accessToken);
        // 创建 AuthRequest 消息类型
        AuthRequest authRequest = new AuthRequest();
        authRequest.setAccessToken(accessToken);
//        System.out.println("afterConnectionEstablished---AuthRequest.TYPE--" + AuthRequest.TYPE);
        // 获得消息处理器
...
//            System.out.println("handleTextMessage --- messageType--" + messageType);
            // 获得消息处理器
...
//            System.out.println("handleTextMessage --- messageClass" + messageClass);
...
//        System.out.println("afterPropertiesSet---HANDLERS.keySet().toString()--" + HANDLERS.keySet().toString());
    }
